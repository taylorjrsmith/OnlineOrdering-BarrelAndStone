...
// Type: TGBS.Website.Migrations.eventCategoryItemmapping2
...
namespace TGBS.Website.Migrations
{
  ...
  [Migration("20210304032245_eventCategoryItem-mapping-2")]
  public class eventCategoryItemmapping2 : Migration
  {
    ...
    {
      migrationBuilder.DropTable("EventCategoryItemMappers");
      migrationBuilder.AddColumn<int>("PizzaSpecialId", "SpecialEventCategories", "INTEGER", nullable: true);
      migrationBuilder.CreateIndex("IX_SpecialEventCategories_PizzaSpecialId", "SpecialEventCategories", "PizzaSpecialId");
      migrationBuilder.AddForeignKey("FK_SpecialEventCategories_Specials_PizzaSpecialId", "SpecialEventCategories", "PizzaSpecialId", "Specials", principalColumn: "Id", onDelete: ReferentialAction.Restrict);
    }
    ...
    protected override void BuildTargetModel(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity("BlazingPizza.EventCategoryItemMapper", (Action<EntityTypeBuilder>) (b =>
      {
        b.Property<Guid>("ID").ValueGeneratedOnAdd().HasColumnType<Guid>("TEXT");
        b.Property<Guid>("EventId").HasColumnType<Guid>("TEXT");
      ...
      modelBuilder.Entity("BlazingPizza.EventCategoryItemMapper", (Action<EntityTypeBuilder>) (b =>
      {
        b.HasOne("BlazingPizza.SpecialEventCategory", "SpecialEventCategory").WithMany().HasForeignKey("EventId").OnDelete(DeleteBehavior.Cascade).IsRequired();
        b.HasOne("BlazingPizza.PizzaSpecial", "PizzaSpecials").WithMany("eventCategoryItemMappers").HasForeignKey("SpecialId").OnDelete(DeleteBehavior.Cascade).IsRequired();
      }));
      modelBuilder.Entity("BlazingPizza.Pizza", (Action<EntityTypeBuilder>) (b =>
      {
