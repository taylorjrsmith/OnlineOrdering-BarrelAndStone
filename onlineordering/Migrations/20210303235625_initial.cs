...
// Type: TGBS.Website.Migrations.initial
...
namespace TGBS.Website.Migrations
{
  ...
  [Migration("20210303235625_initial")]
  public class initial : Migration
  {
    ...
    {
      migrationBuilder.DropTable("DrinkItems");
      migrationBuilder.DropTable("NotificationSubscriptions");
      migrationBuilder.DropTable("PizzaTopping");
      migrationBuilder.DropTable("Settings");
      migrationBuilder.DropTable("SpecialEventCategories");
      migrationBuilder.DropTable("Drinks");
      migrationBuilder.DropTable("Pizzas");
      migrationBuilder.DropTable("Toppings");
      migrationBuilder.DropTable("Orders");
      migrationBuilder.DropTable("Specials");
    }
