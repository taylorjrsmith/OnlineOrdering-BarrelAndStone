...
// Type: TGBS.Website.Migrations.eventItems
...
namespace TGBS.Website.Migrations
{
  ...
  [Migration("20210303235858_eventItems")]
  public class eventItems : Migration
  {
    protected override void Up(MigrationBuilder migrationBuilder) => migrationBuilder.AddColumn<bool>("IsEventItem", "Specials", defaultValue: ((object) false));

    protected override void Down(MigrationBuilder migrationBuilder) => migrationBuilder.DropColumn("IsEventItem", "Specials");
